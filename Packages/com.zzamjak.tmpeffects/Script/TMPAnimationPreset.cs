...
namespace CAT.UI
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "TMPAnimationPreset",
        menuName = "CAT/UI/TMP Animation Preset")]
    public class TMPAnimationPreset : ScriptableObject
    {
        // ─────────────────────────────────────────────
        // Inspector 설정
        // ─────────────────────────────────────────────
        ...
        [Tooltip("최초 실행 딜레이 (초). Play On Enable / 코드 Play() 동일하게 타임라인에 적용")]
        [SerializeField, Range(0f, 5f)]
        private float _initialDelay = 0f;

        [Tooltip("스케일/회전 피벗 (정규화 0~1). X: 좌변~우변, Y: baseLine~ascender. 기본 (0.5, 0) = 가로 중앙 + 베이스라인")]
        [SerializeField]
        ...
        /// <summary>
        /// TMPAnimation 컴포넌트의 현재 값을 이 프리셋으로 복사
        /// </summary>
        public void CopyFrom(TMPAnimation source)
        {
            if (source == null) return;

            _characterDelay = source.CharacterDelay;
            _initialDelay = source.InitialDelay;
            _pivot = source.Pivot;
            ...
            _appearCurve = source.AppearCurve;
            ...
            _disappearCurve = source.DisappearCurve;
            ...
            _enableImpact = source.EnableImpact;
            _impactScale = source.ImpactScale;
            _impactPosition = source.ImpactPosition;
            _impactRotation = source.ImpactRotation;
            _impactDuration = source.ImpactDuration;
            _impactCurve = source.ImpactCurve;
            _impactCharacterDelay = source.ImpactCharacterDelay;
        }
        ...
        /// 빌트인 프리셋: 튕기며 등장
        /// </summary>
        public static TMPAnimationPreset CreateBounceAppear()
        {
            var preset = CreateInstance<TMPAnimationPreset>();
            ...
            preset._appearCurve = ICurve.Ease(EaseType.OutBounce);
        ...
        /// 빌트인 프리셋: Y축 웨이브 반복
        /// </summary>
        public static TMPAnimationPreset CreateWaveLoop()
        {
            var preset = CreateInstance<TMPAnimationPreset>();
            ...
            preset._loopCurve = ICurve.Ease(EaseType.InOutSine);
            preset._loopCount = -1;
        ...
        /// </summary>
        public static TMPAnimationPreset CreateScaleDisappear()
        {
            var preset = CreateInstance<TMPAnimationPreset>();
            ...
            preset._disappearCurve = ICurve.Ease(EaseType.InBack);
        ...
        /// 빌트인 프리셋: 회전하며 등장
        /// </summary>
        public static TMPAnimationPreset CreateRotateAppear()
        {
            var preset = CreateInstance<TMPAnimationPreset>();
            ...
            preset._appearCurve = ICurve.Ease(EaseType.OutBack);
        ...
        /// 빌트인 프리셋: 페이드 인/아웃
        /// </summary>
        public static TMPAnimationPreset CreateFadeInOut()
        {
            var preset = CreateInstance<TMPAnimationPreset>();
            ...
            preset._appearCurve = ICurve.Ease(EaseType.OutQuad);
            ...
            preset._disappearCurve = ICurve.Ease(EaseType.InQuad);
